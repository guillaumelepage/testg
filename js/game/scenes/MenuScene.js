...
const TUTORIAL = [
  {
    ...
    lines: [
      ...
      '• Choisissez un Héros unique au début — il gagne de l\'XP et des artéfacts.',
      '• Des vagues ennemies arrivent régulièrement. Résistez !',
      '',
  ...
  },
  {
    ...
    lines: [
      ...
      '',
      'Cliquez sur une unité pour la sélectionner, puis sur une case pour la déplacer.',
    ],
  },
  {
    ...
    lines: [
      ...
      '  ① Sélectionnez un Paysan',
      '  ② Cliquez sur une ressource (bois 🪵, pierre ⛰, or 💰, nourriture 🌾)',
      '     → Le paysan se déplace et récolte automatiquement.',
      '',
      'Construire un bâtiment :',
      '  ① Cliquez sur  🏗 Construire  (bas de l\'écran)',
      '  ② Choisissez un bâtiment dans le menu',
      '  ③ Cliquez sur une case libre pour le poser',
    ],
  },
  {
    title: 'Population & Unités',
    lines: [
      'Vos unités viennent de votre POPULATION :',
      '  • Des enfants naissent dans les Maisons (toutes les ~4 min)',
      '  • À 16 ans, un habitant devient adulte — construisez-lui une maison !',
      '  • Sans maison, il devient SDF et rejoint les ennemis en 1.5 min.',
      '',
      'Entraîner une unité (Caserne, Écurie…) :',
      '  → Consomme un adulte disponible de votre population.',
      '',
      '⚠ Gérez votre démographie : sans habitants, pas d\'armée !',
    ],
  },
  {
    title: 'Le Système de Combat',
    lines: [
      'Déplacer une unité sur une case ennemie → COMBAT !',
      '',
      'Tour par tour : choisissez parmi 4 attaques à chaque round.',
      '4 types : LOURD · LÉGER · CAVALERIE · MAGIE',
      '',
      '  LOURD > LÉGER      CAVALERIE > LOURD',
      '  MAGIE > LOURD      LÉGER > MAGIE',
      '',
      '• Vos alliés proches rejoignent automatiquement le combat.',
      '• Toutes les unités récupèrent leurs PV après la bataille.',
    ],
  },
  {
    title: 'Villages & Donjons',
    lines: [
      'Villages ennemis (tours sur la carte) :',
      '  → Déplacez une unité dessus pour assiéger.',
      '  → Capturez-les pour étendre votre territoire et gagner des ressources.',
      '  ⚠ Les gardes du village sont agressifs — ils attaquent si vous approchez !',
      '',
      'Donjons (entrées de grotte 🕳) :',
      '  ① Sélectionnez votre Héros',
      '  ② Cliquez sur l\'entrée de la grotte',
      '  → 3 salles de combat + un Boss. Victoire = Artéfact permanent pour le héros.',
    ],
  },
  {
    title: 'Événements & Boss',
    lines: [
      'Toutes les 3 minutes, un événement aléatoire survient :',
      '  🌿 Marchand, sécheresse, tempête, incendie, refugiés…',
      '  💀 Raid ennemi, meute de loups, nuit de sang…',
      '  ✨ Découverte (réduction de construction), trêve temporaire…',
      '',
      '👑 Le TYRAN DES OMBRES peut apparaître :',
      '  → Boss très agressif avec un grand rayon de détection.',
      '  → Vaincre-le en combat pour protéger votre camp !',
    ],
  },
  {
    ...
    lines: [
      ...
      '',
      '• Ressources PARTAGÉES entre les deux joueurs.',
      '• Chacun contrôle toutes les unités alliées.',
      '• En cas de coupure réseau : reconnexion automatique.',
      '  → Rechargez la page si besoin — une bannière "Reprendre" apparaîtra.',
      '',
      '⚔️  Bonne chance, Seigneurs !',
    ],
  },
];
